...
- looking [example file](./example.py) , [minimal example](./minimalistExample.py) , [async example](./asyncExample.py) , and [final example](finalExample.py) for learn more about conceptual.
